...
urlpatterns = [
    ...
    path('register_organizer', login_required(views.register_Organizer.as_view()), name='register_organizer'),
    path('register_staff', login_required(views.register_Staff.as_view()), name='register_staff'),
